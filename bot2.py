...
bot = telebot.TeleBot("6097411544:AAH3tD6SIr1sGruFH4Lp381v9l1wu26FNCo")


class DataBase:
	def __init__(self):
		cluster = MongoClient("mongodb+srv://fuckireta:R3tard3dk1d1337@cluster0.ixchiuf.mongodb.net/?retryWrites=true&w=majority")

		self.db = cluster["peacedeath"]
...
def get_question_message(user):
	if user["question_index"] == db.questions_count:
		...
		if percents < 40:
			smile = "айфон 14 в кредит"
		elif percents < 60:
			smile = "сало на волосах лбо"
		elif percents < 90:
			smile = "мурчик"
		else:
			smile = "сиськи вероники на пол экрана"
